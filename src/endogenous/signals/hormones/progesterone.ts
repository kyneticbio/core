...
export const progesterone: SignalDefinition = {
  ...
  dynamics: {
    setpoint: (ctx, state) => {
      ...
      const baselineP4 =
        ctx.subject.bloodwork?.hormones?.progesterone_ng_mL ?? 0.5;
  ...
  monitors: [
    {
      ...
      description:
        "Strong progesterone levels indicate a healthy luteal phase and successful ovulation.",
    },
    {
      ...
      description:
        "Low progesterone in the second half of your cycle can lead to anxiety, sleep issues, and PMS.",
    },
  ],
};
