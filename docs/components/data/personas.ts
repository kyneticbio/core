...
export const PERSONAS: PersonaDef[] = [
  // 1. Focus Seeker
  {
    id: "focus",
    icon: "\u{1F9E0}",
    headline: "Neurodivergence",
    subhead:
      "See how ADHD changes your neurochemistry \u2014 and what actually helps.",
    accent: "#ff6b6b",
    conditions: [
  ...
  // 2. Calm Seeker
  {
    id: "calm",
    icon: "\u{1F9D8}",
    headline: "Mood Management",
    subhead:
      "Watch your stress chemistry respond to different calming strategies.",
    accent: "#7c3aed",
    conditions: [
      {
        key: "anxiety",
        enabledByDefault: true,
        defaultParams: { reactivity: 0.5 },
      },
      {
        key: "depression",
        enabledByDefault: false,
        defaultParams: { severity: 0.5 },
      },
    ],
    interventions: [
      {
        key: "ashwagandha",
        enabledByDefault: true,
        defaultParams: { mg: 600 },
      },
      { key: "ltheanine", enabledByDefault: true, defaultParams: { mg: 200 } },
      {
        key: "breathwork",
        enabledByDefault: true,
        defaultParams: { type: "calm", intensity: 1.0 },
      },
  ...
  // 3. Sleep Optimizer
  {
    id: "sleep",
    icon: "\u{1F319}",
    headline: "Sleep Quality",
    subhead:
      "Model your evening chemistry and find what tips the balance toward sleep.",
    accent: "#1e40af",
    conditions: [
      {
        key: "insomnia",
        enabledByDefault: true,
        defaultParams: { severity: 0.4 },
      },
    ],
    interventions: [
  ...
  // 4. Body Builder
  {
    id: "strength",
    icon: "\u{1F4AA}",
    headline: "Growth & Recovery",
    subhead:
      "See how training, nutrition, and recovery stack at the molecular level.",
    accent: "#f59e0b",
    conditions: [],
    interventions: [
      {
      ...
      { key: "creatine", enabledByDefault: true, defaultParams: { grams: 5 } },
      {
        key: "coldExposure",
        enabledByDefault: false,
        defaultParams: { temperature: 10, intensity: 1.0 },
      },
    ],
    signals: [
  ...
  // 6. Cycle Tracker
  {
    ...
    interventions: [
      ...
      { key: "omega3", enabledByDefault: false, defaultParams: { mg: 2000 } },
      {
        key: "bComplex",
        enabledByDefault: false,
        defaultParams: { b12_mcg: 500, folate_mcg: 400 },
      },
    ],
    signals: [
